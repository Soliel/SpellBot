...
//CommandMessage is used to bundle command string and message string
...
type CommandNotHandledError struct {
	command string
	desc    string
}
...
func (e CommandNotHandledError) Error() string {
